  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <form
        ...
        className="rounded-2xl border border-border bg-background p-2 shadow-sm transition-shadow focus-within:ring-2 focus-within:ring-ring/40"
      >
        <Textarea
          value={body}
        ...
        <div className="mt-1 flex items-center justify-between pl-2">
          <span className="text-[11px] text-muted-foreground">Ctrl/⌘ + Intro para enviar</span>
