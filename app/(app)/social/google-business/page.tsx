      ...
      {!configured ? (
        ...
        <>
            ...
            {GOOGLE_BUSINESS_DAILY_METRICS.map((metric) => (
              <Card key={metric}>
                ...
                <CardContent>
                  ...
                  <p className="text-muted-foreground mt-1 text-[11px]">Últimos 30 días</p>
                </CardContent>
              </Card>
            ))}
          </div>
          <div className="grid gap-3 sm:grid-cols-2">
            <Link
              href="/social/reviews"
              className="group border-border bg-card hover:border-primary/40 flex items-center gap-3 rounded-xl border p-4 transition-colors"
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-muted-foreground text-xs">Leer y responder reseñas de Google</p>
              </div>
