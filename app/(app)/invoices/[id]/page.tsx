    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
        <div className="flex min-w-0 flex-col gap-6">
          ...
          <InvoiceTimeline
            issueDate={(invoice.issue_date as string | null) ?? null}
            ...
            payments={(payments ?? []).map((payment) => ({
              ...
              confirmed_at: (payment.confirmed_at as string | null) ?? null,
            }))}
            automation={
              paymentFollowUp
                ? {
                    id: paymentFollowUp.id as string,
                    status: paymentFollowUp.status as string,
                    run_at: paymentFollowUp.run_at as string,
                    sent_at: (paymentFollowUp.sent_at as string | null) ?? null,
                    cancelled_at: (paymentFollowUp.cancelled_at as string | null) ?? null,
                  }
                : null
            }
          />
