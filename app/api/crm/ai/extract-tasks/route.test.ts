...
vi.mock("@/lib/leads/queries", () => ({
  getLeadDetail: vi.fn(async () => ({
    ...
    interactions: [{ type: "call", subject: null, body: null, payload: { transcript: "No acordamos un siguiente paso." }, created_at: "2026-08-01T10:00:00.000Z" }],
    proposals: [], projects: [], invoices: [], tasks: [], reminders: [], attachments: [],
  })),
}));
