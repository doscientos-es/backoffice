...
import { exchangeGoogleBusinessCode, googleBusinessRedirectUri } from '@/lib/social/google-business'
...
export async function GET(req: NextRequest) {
  ...
  if (!savedState || savedState !== state) {
    return htmlPage('Error', `<p class="err">State inválido. Vuelve a iniciar el proceso.</p>`, 400)
  }
