...
export type {
  ...
  VerifactuErrorCode,
} from "@/lib/verifactu/client";
export { buildVerifactuXml, submitToVerifactu } from "@/lib/verifactu/client";

// ── QR generation ────────────────────────────────────────────────────────────
export type { QrParams } from "@/lib/verifactu/qr";
export { buildQrDataUrl, buildQrUrl } from "@/lib/verifactu/qr";

// ── XML well-formedness validation ───────────────────────────────────────────
export type { XmlValidationResult } from "@/lib/verifactu/validate";
export { validateVerifactuXml } from "@/lib/verifactu/validate";

// ── Logging port ─────────────────────────────────────────────────────────────
export { type VerifactuLogger, noopLogger } from "@/lib/verifactu/logger";

// ── High-level facade (recommended entry point) ──────────────────────────────
export type { VerifactuClient } from "@/lib/verifactu/facade";
export { createVerifactuClient } from "@/lib/verifactu/facade";
