...
10. **Confidencialidad, datos y evidencia de firma.** Cada parte protegerá la información confidencial de la otra y solo la usará para ejecutar este encargo. Si Doscientos trata datos personales por cuenta del Cliente, las partes formalizarán, cuando sea exigible, el correspondiente acuerdo de encargo de tratamiento antes de dicho acceso. Doscientos tratará los datos de contacto y la evidencia de aceptación como responsable para gestionar la relación contractual, acreditar el consentimiento y atender obligaciones legales, durante la relación y los plazos de conservación o prescripción aplicables.

11. **Subcontratación.** Doscientos podrá recurrir a profesionales o proveedores cualificados para ejecutar el encargo, permaneciendo responsable de la coordinación de sus prestaciones y exigiéndoles obligaciones de confidencialidad y protección de datos acordes con el servicio.

12. **Fuerza mayor.** Ninguna parte responderá por retrasos o incumplimientos causados por hechos fuera de su control razonable, incluidos fallos generales de proveedores, ciberincidentes no imputables, conflictos laborales, desastres naturales o actuaciones de autoridades. La parte afectada avisará sin demora razonable y ambas cooperarán para reducir el impacto; si la situación se prolonga de forma sustancial, cualquiera podrá resolver las prestaciones pendientes sin perjuicio de los importes ya devengados.
...
14. **Responsabilidad.** Salvo norma imperativa aplicable, dolo, culpa grave o responsabilidad que legalmente no pueda excluirse, la responsabilidad total de Doscientos se limitará al importe efectivamente abonado por el Cliente por el servicio que origine la reclamación. En relaciones entre empresas, Doscientos no responderá por lucro cesante, pérdida de negocio, pérdida de datos, daños indirectos o perjuicios consecuenciales que no fueran previsibles de forma razonable al contratar.

15. **Comunicaciones, cesión y separabilidad.** Las comunicaciones operativas y las notificaciones se realizarán por los correos electrónicos y canales indicados en la propuesta o posteriormente acordados por escrito. El Cliente no podrá ceder el encargo sin autorización previa de Doscientos; Doscientos podrá cederlo a una entidad sucesora o vinculada que asuma estas obligaciones, informando al Cliente cuando resulte exigible. La nulidad de una cláusula no afectará a las restantes, que conservarán su eficacia. La tolerancia o falta de ejercicio de un derecho no supone renuncia a él.
